...
url_label = tk.Label(root, text='Enter a URL:', fg='green', bg='white', font=('Arial', 12))
url_label.grid(row=0, column=0, padx=10, pady=10)
url_entry = tk.Entry(root, width=50, fg='black', bg='black', font=('Arial', 12))
url_entry.grid(row=0, column=1, padx=10, pady=10)

# Create the button to send the URL to the server
send_button = tk.Button(root, text='Send', command=send_url, fg='black', bg='green', font=('Arial', 12))
send_button.grid(row=1, column=1, padx=10, pady=10)

# Create the output text box and label
output_label = tk.Label(root, text='Output:', fg='green', bg='black', font=('Arial', 12))
output_label.grid(row=2, column=0, padx=10, pady=10)
output_text = tk.Text(root, width=50, height=10, fg='black', bg='white', font=('Arial', 12))
